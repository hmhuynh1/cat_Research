...
export default function Advice() {
	...
	return (
		<Box backgroundImage={`url(${catBG})`} backgroundSize='cover' backgroundPosition='center' backgroundRepeat='no-repeat' padding='40px' minHeight='80vh'>
			<Flex direction={['column', 'column', 'row']} gap='30px' padding='5px' justify='flex-start' align='center'>
				<Box as='section' fontWeight={50} padding='30px' bg='rgba(0, 0, 0, 0.8)' borderRadius='md' maxWidth='450px' width='100%'>
					...
					<form onSubmit={submitHandler}>
						<FormControl id='picture' mb={4} isRequired>
							...
							<Input type='file' name='uploaded_file' accept='image/*' onChange={fileChangeHandler} bg='white' color='black' />
						</FormControl>

						<FormControl id='breed' mb={4} isRequired>
							<FormLabel color='white'>Cat Breed:</FormLabel>
							<Input name='breed' type='text' value={form.breed} onChange={changeHandler} placeholder='Your cat breed' bg='white' color='black' />
						</FormControl>

						<FormControl id='food' mb={4} isRequired>
							<FormLabel color='white'>Food Brand:</FormLabel>
							<Input name='food' type='text' value={form.food} onChange={changeHandler} placeholder='Food brand' bg='white' color='black' />
						</FormControl>

						<FormControl id='link' mb={4} isRequired>
							<FormLabel color='white'>Where to buy:</FormLabel>
							<Input name='link' type='text' value={form.link} onChange={changeHandler} placeholder='URL website link' bg='white' color='black' />
						</FormControl>

						<FormControl id='toy' mb={4} isRequired>
							<FormLabel color='white'>Toy Brand:</FormLabel>
							<Input name='toy' type='text' value={form.toy} onChange={changeHandler} placeholder='Toy brand' bg='white' color='black' />
						</FormControl>
