			...
			<section>
				<div id='center'>
					<section id='search-form-section d-flex flex-column gap-4'>
						<form asp-action='Advice' method='get' className='d-flex flex-column gap-4'>
							<input type='search' className='w-full p-2' name='query' placeholder='Type cat advice...' id='search-box' />
				...
				<section className='mt-4'>
					<Flex gap={'20px'}>
						{data.map((x: any, i) => {
							return (
								<Box key={i} flex={'1 1 32%'} color={'white'} border={'solid 1px white'} padding={'20px'}>
